...
import { View, StyleSheet, ListRenderItem, Image, Text, TouchableOpacity } from 'react-native'
  ...
  return (
    ...
    {/* <View style={styles.icon_view_one}> */}
              <TouchableOpacity onPress={()=>{props.navigation.goBack()}}>
                <ChevronLeftIcon iconName="chevron-left" size="5" mx={3} marginTop={5} />
              </TouchableOpacity>
              {/* </View> */}
      <Text style={styles.faqtext}>My Profile</Text>
    {/* </View> */}
    {/* <View style={{backgroundColor:'orange',marginTop:20,paddingVertical:20}}> */}
    <Image source={profilelogo} style={{borderRadius:100,alignSelf:'center',top:20}}></Image>
    <View>
    <Image source={backimg} style={{alignSelf:'center',opacity:0.3,bottom:50}}></Image>
